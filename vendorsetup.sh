...
git clone https://github.com/Pixel7Pro-Cheetah/device_google_gs201.git -b everest-14 device/google/gs201
...
# Dummy Kernel
echo 'Cloning dummy kernel tree'
git clone --depth=1 --recursive https://github.com/Pixel7Pro-Cheetah/kernel_google_gs201 -b pantah kernel/google/pantah/cheetah
